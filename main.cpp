 ...
 *
 * Author/Date : C.B. Lirakis / 16-Dec-23
 *
 * Description :
 *
 ...
 *
 * Change Descriptions :
 * 20-Mar-26 made specific to PiDA program. 
 *
...
static bool Initialize(void)
{
    ...
    version = atof( msg);
    logger = new CLogger("PIDA.log", "PiDA", version);
...
int main(int argc, char **argv)
{
	...
	if (Filename !=NULL)
	{
	    PiDA *pModule = new PiDA("PIDA.cfg", Filename);
